      ...
      >
        <View
          style={{
            ...
            position: "absolute",
            left: 10,
            bottom: props.fullscreen.inFullscreen ? 20 : 5,
          }}
        >
          {props.timeVisible && (
            <Text
          ...
          <Slider
            ...
            style={[
              props.slider.style,
              {
                flex: 1,
                height: 40,
                bottom: props.fullscreen.inFullscreen ? 25 : 0,
              },
            ]}
            value={
        ...
        <View
          style={{
            position: "absolute",
            right: 10,
            bottom: props.fullscreen.inFullscreen ? 20 : 0,
            justifyContent: "center",
            alignItems: "center",
            flexDirection: "row",
            gap: 10,
